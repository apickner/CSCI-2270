...
// ------------------------------------------------------------------------------------------
    ...
    // prints each word vertex with the overloaded WordVertex output stream operator
    void printVertices();

    // prints a given word vertex with the overloaded WordVertex output stream operator
    void printVertex(std::string);

    // prints each word vertex word, stored in a vector; so we can iterate through the hash table
    void printVerticesFromVector();

    // prints any words that start sentences, stored in a vector
    void printStartWords();

    // prints the file contents, stored in a vector
    void printFileContents();

    // prints the author object with the overloaded author output stream operator
    void printAuthor();
...
// ------------------------------------------------------------------------------------------
    ...
    std::string create1stOrderSentence();
...
*/
    ...
    // create a sentence with parameter markov order
    // std::string createSentence(int);

    // picks a starting word at random
    std::string pickStartWord();

    // gets the probability of an edge
    double getEdgeProbability(std::string, std::string, int);
    ...
    WordVertex* get1stOrderWord(WordVertex*);
