...
#########################################################
	...
	os.system("g++ c++/HashTable.cpp c++/ProductionWordGraphClass.cpp c++/MainDriver.cpp c++/TextTools.cpp c++/FileToString.cpp c++/AuthorStruct.cpp -std=c++11 -o Main")

	executable = "./Main" + space + file_name
	...
	user_input = raw_input("Hit enter to generate a random Tweet, or Q when you want to quit!").lower()
